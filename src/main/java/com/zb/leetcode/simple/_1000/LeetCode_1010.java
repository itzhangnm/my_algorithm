...
public class LeetCode_1010 {
    ...
    public static void main(String[] args) {
        LeetCode_1010 leetCode_1010 = new LeetCode_1010();
        System.out.println(leetCode_1010.numPairsDivisibleBy60(new int[]{30,20,150,100,40}));
        System.out.println(leetCode_1010.numPairsDivisibleBy60(new int[]{60,60,60}));
    }

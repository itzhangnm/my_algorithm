...
public class Array_1002 {
    ...
    public static void main(String[] args) {
        Array_1002 array_1002 = new Array_1002();
        System.out.println(array_1002.commonChars(new String[]{"bella","label","roller"}));
        System.out.println(array_1002.commonChars(new String[]{"cool","lock","cook"}));
    }
